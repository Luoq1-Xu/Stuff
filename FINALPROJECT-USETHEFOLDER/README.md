...
- For "Called" strike and balls (when the player did not swing at all), all details are updated when the ball has finished it ball flight and arrived at the plate. 
