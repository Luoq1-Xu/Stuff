...
leftypitcher = pygame.image.load('lefty.png').convert_alpha()
leftywindup = pygame.image.load('windup.png').convert_alpha()
leftyfollowthrough = pygame.image.load('salemini.png').convert_alpha()
leftyend = pygame.image.load('salefrontmini.png').convert_alpha()
